...
export default function AdminLayout() {
  ...
  // Fetch pending SAIL swap requests count
useEffect(() => {
  ...
  const interval = setInterval(fetchPendingSwapCount, 30000);
  ...
  const navItems = [
    ...
    {
  id: 'sail-swaps',
  path: '/admin/sail-swaps',
  label: 'SAIL Swap Requests',
  icon: '💸',
  badge: true
},
  ];
        ...
        <nav className="flex flex-col gap-1 flex-1 p-4 mt-2 overflow-y-auto">
          ...
          {navItems.map(item => (
            ...
            >
              ...
              {!isCollapsed && item.id === 'sail-swaps' && pendingSwapCount > 0 && (
