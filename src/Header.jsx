...
import { Anchor, ChevronDown, Flame, LayoutGrid, ShieldCheck } from 'lucide-react';
                ...
                {isProfileOpen && (
                  <div className="absolute top-full right-0 pt-2 w-52 z-50">
                    <div className="bg-white rounded-xl shadow-xl border border-slate-200 p-2 flex flex-col gap-1">
                      ...
                      <Link to="/profile" className="flex items-center px-3 py-2 rounded-lg text-sm font-semibold text-slate-600 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                        Settings
                      </Link>
