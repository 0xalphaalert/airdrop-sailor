...
import FundraisingPageMobile from './mobile/pages/FundraisingPageMobile';
  ...
  if (isMobile) {
    return (
      <FundraisingPageMobile 
        ...
        formatFundingAmount={formatFundingAmount}
        getRoundStyle={getRoundStyle}
        getAirdropProbability={getAirdropProbability}
      />
    );
  }
  // -------------------------------
