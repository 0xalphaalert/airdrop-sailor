...
import { buildCompletionPayload, calculateStreak, emitTrackerUpdate } from './trackerUtils';
...
export default function TrackerDaily() {
  ...
  const completeTask = async (task) => {
    try {
      ...
      // Recurrence maths lives in trackerUtils so Daily and Tasks stay in sync.
      ...
      // Push the fresh Streak / XP / SAIL totals into TrackerHeader instantly.
